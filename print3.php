...
<head>
    ...
    <style>
        ...
        body{ background-color: #fff;font-size: 22px;font-family: 'Kanit', sans-serif;padding: 0;}
        ...
        .panel-body{padding: 28px 10px 23px 35px;}        
        .cod{font-weight: 600; padding-top: 25px;font-size: 24px;text-align: center;}
        
        .order{ line-height: 8px;font-size: 14px;border-top:1px solid #000;padding: 6px 35px;}
