        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" >
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h1 class="page-header">คำนวณสินเชื่อรถ</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                    ...
                    <div class="col-lg-12">                    
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" role="form" id="frmcal">
                                    <div class="form-group">
                                        <label class="control-label col-sm-2" for="sell_date">ค่างวดต่อเดือน :</label>
                                        <div class="col-sm-4 "> 
                ...
                $('#btncal').click(function(){
                    if($('#price').val() != "" && $('#payment_percent1').val() != "" 
                         && $('#payment').val() != "" && $('#interest_rate').val() != ""){
                            ...
                            $('#result0').val(result0.format());
                            $('#result1').val(toprated.format());
                            $('#result2').val(result2.format(2));
                            $('#result3').val((toprated+result2).format(2));
                        }
                });
            });
