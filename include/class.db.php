...
//        mail( SEND_ERRORS_TO, 'Database Error', $message, $headers);
     ...
     *
     */
    public function num_rows( $table,$condition,$field="*"  )
    {
...
//        pr($query);exit;
    ...
    public function num_rows_bysql( $query  )
    {
...
//        pr($query);exit;
    ...
    public function select( $table,$condition,$field="*"  )
    {
     ...
     *
     */
    public function selects( $table,$condition,$field="*" )
    {
